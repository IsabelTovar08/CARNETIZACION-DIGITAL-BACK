...
namespace Entity.Migrations
{
    ...
    [Migration("20250720013751_Init-MER")]
    partial class InitMER
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Models.Notifications.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.InternalDivision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.OrganizationalUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.OrganizationalUnitBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Organization.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.PersonDivisionProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Models.Card", b =>
                {
                    b.HasOne("Entity.Models.PersonDivisionProfile", "PersonDivisionProfile")
                        .WithOne("Card")
                        .HasForeignKey("Entity.Models.Card", "PersonDivissionProfileId")
            ...
            modelBuilder.Entity("Entity.Models.Notifications.Notification", b =>
                {
                    b.HasOne("Entity.Models.Notifications.NotificationType", "NotificationType")
            ...
            modelBuilder.Entity("Entity.Models.Organization.Branch", b =>
                {
                    ...
                    b.HasOne("Entity.Models.Organization.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity.Models.Organization.InternalDivision", b =>
                {
                    b.HasOne("Entity.Models.Organization.Branch", null)
                        .WithMany("InternalDivisions")
                        .HasForeignKey("BranchId");

                    b.HasOne("Entity.Models.Organization.OrganizationalUnit", "OrganizationalUnit")
            ...
            modelBuilder.Entity("Entity.Models.Organization.OrganizationalUnitBranch", b =>
                {
                    b.HasOne("Entity.Models.Organization.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Models.Organization.OrganizationalUnit", "OrganizationUnit")
            ...
            modelBuilder.Entity("Entity.Models.PersonDivisionProfile", b =>
                {
                    b.HasOne("Entity.Models.Organization.InternalDivision", "InternalDivision")
                        .WithMany()
                    ...
                    b.HasOne("Entity.Models.ModelSecurity.Person", "Person")
                        ...
                        .HasForeignKey("Entity.Models.PersonDivisionProfile", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entity.Models.Organization.Profile", "Profile")
                        .WithOne("PersonDivisionProfile")
                        .HasForeignKey("Entity.Models.PersonDivisionProfile", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
